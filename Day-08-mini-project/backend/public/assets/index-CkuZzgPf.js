...
` +
    ...
    var Hn = Cn(
      ...
      Gn = Cn(h({}, wn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Kn = Cn(
        h({}, jn, {
          deltaX: function (e) {
            return `deltaX` in e
      ...
      qn = Cn(h({}, wn, { newState: 0, oldState: 0 })),
      Jn = [9, 13, 27, 32],
      Yn = pn && `CompositionEvent` in window,
      Xn = null;
    pn && `documentMode` in document && (Xn = document.documentMode);
    var Zn = pn && `TextEvent` in window && !Xn,
      Qn = pn && (!Yn || (Xn && 8 < Xn && 11 >= Xn)),
      $n = ` `,
      er = !1;
    function tr(e, t) {
      switch (e) {
    ...
    var Rl = {
      ...
      fu = null;
    function pu() {
      return G & 2 && J !== 0 ? J & -J : O.T === null ? M() : dd();
    }
    function mu() {
      if (Jl === 0)
        if (!(J & 536870912) || L) {
...
function $e(e) {
  return Ze(e.replace(Xe, ``));
}
function et(e) {
  return e === !1 || e == null ? e : j.isArray(e) ? e.map(et) : $e(String(e));
}
function tt(e) {
...
var ot = class {
  ...
  set(e, t, n) {
    ...
    else if (j.isString(e) && (e = e.trim()) && !nt(e)) a(Je(e), t);
...
`);
  ...
  static accessor(e) {
    let t = (this[Ye] = this[Ye] = { accessors: {} }).accessors,
      n = this.prototype;
    function r(e) {
      let r = Qe(e);
      t[r] || (at(n, e), (t[r] = !0));
...
(ot.accessor([
  ...
  j.reduceDescriptors(ot.prototype, ({ value: e }, t) => {
...
function lt(e, t) {
  let n = new Set(t.map((e) => String(e).toLowerCase())),
    ...
    i = (e) => {
      ...
      (e instanceof ot && (e = e.toJSON()), r.push(e));
      let t;
      if (j.isArray(e))
        ((t = []),
          e.forEach((e, n) => {
        ...
        if (!j.isPlainObject(e) && ct(e)) return (r.pop(), e);
...
var M = class e extends Error {
  ...
  toJSON() {
    let e = this.config,
      ...
      n = j.isArray(t) && t.length > 0 ? lt(e, t) : j.toJSONObject(e);
    return {
...
function ft(e) {
  return j.isArray(e) && !e.some(ut);
}
var pt = j.toFlatObject(j, {}, null, function (e) {
...
function mt(e, t, n) {
  ...
  function d(e, n, i) {
    ...
    return ut(e) ? !0 : (t.append(N(i, n, a), u(e)), !1);
  }
  let f = [],
    p = Object.assign(pt, {
      defaultVisitor: d,
...
var bt = class {
  ...
  Tt =
    P && (!wt || [`ReactNative`, `NativeScript`, `NS`].indexOf(wt.product) < 0),
  Et =
    typeof WorkerGlobalScope < `u` &&
    self instanceof WorkerGlobalScope &&
    typeof self.importScripts == `function`,
  Dt = (P && window.location.href) || `http://localhost`,
  Ot = { ...Ct, ...St };
function kt(e, t) {
  return mt(e, new Ot.classes.URLSearchParams(), {
    visitor: function (e, t, n, r) {
      return Ot.isNode && j.isBuffer(e)
    ...
    return (
      ...
      s
        ? (j.hasOwnProp(r, a)
            ...
            : (r[a] = n),
          !o)
        : ((!r[a] || !j.isObject(r[a])) && (r[a] = []),
          t(e, n, r[a], i) && j.isArray(r[a]) && (r[a] = jt(r[a])),
          !o)
    );
  }
...
var Nt = (e, t) => (e != null && j.hasOwnProp(e, t) ? e[t] : void 0);
function Pt(e, t, n) {
  if (j.isString(e))
    try {
...
var Ft = {
  ...
  transformRequest: [
    function (e, t) {
      ...
      let a;
      if (i) {
        let t = Nt(this, `formSerializer`);
        if (n.indexOf(`application/x-www-form-urlencoded`) > -1)
          return kt(e, t).toString();
      ...
      return i || r ? (t.setContentType(`application/json`, !1), Pt(e)) : e;
    },
  ],
  transformResponse: [
    function (e) {
      let t = Nt(this, `transitional`) || Ft.transitional,
      ...
      if (e && j.isString(e) && ((n && !r) || i)) {
        ...
        try {
          return JSON.parse(e, Nt(this, `parseReviver`));
        } catch (e) {
          if (n)
            throw e.name === `SyntaxError`
              ? M.from(e, M.ERR_BAD_RESPONSE, this, null, Nt(this, `response`))
              : e;
        }
      }
      return e;
...
var $t = [`content-type`, `content-length`];
function en(e, t, n) {
  if (n !== `content-only`) {
    e.set(t);
    return;
  ...
  Object.entries(t).forEach(([t, n]) => {
    $t.includes(t.toLowerCase()) && e.set(t, n);
  });
}
var tn = (e) =>
  ...
  nn = (e) => {
    ...
    if (
      ...
      (t.url = yt(Xt(l, d, u), e.params, e.paramsSerializer)),
      c &&
        s.set(
          `Authorization`,
          `Basic ` +
            btoa((c.username || ``) + `:` + (c.password ? tn(c.password) : ``)),
        ),
      j.isFormData(r) &&
        (Ot.hasStandardBrowserEnv || Ot.hasStandardBrowserWebWorkerEnv
          ? s.setContentType(void 0)
          : j.isFunction(r.getHeaders) &&
            en(s, r.getHeaders(), n(`formDataHeaderPolicy`))),
      Ot.hasStandardBrowserEnv &&
        (j.isFunction(i) && (i = i(t)), i === !0 || (i == null && Kt(t.url))))
    ) {
      let e = a && o && qt.read(o);
      e && s.set(a, e);
    }
      ...
      let n = new AbortController(),
        ...
        i = function (e) {
          if (!r) {
            ...
            n.abort(
              t instanceof M ? t : new Rt(t instanceof Error ? t.message : t),
            );
          }
        },
        a =
  ...
  sn = async function* (e, t) {
    for await (let n of cn(e)) yield* on(n, t);
  },
  cn = async function* (e) {
...
var dn = `1.16.0`,
  ...
  hn = (e) => {
    ...
    let { fetch: i, Request: a, Response: o } = e,
      s = i ? pn(i) : typeof fetch == `function`,
      c = pn(a),
      l = pn(o);
    if (!s) return !1;
    let u = s && pn(n),
      ...
      p = l && u && mn(() => j.isReadableStream(new o(``).body)),
      m = { stream: p && ((e) => e.body) };
    s &&
    ...
    let h = async (e) => {
        ...
        if (j.isSpecCompliantForm(e))
          return (
            await new a(Ot.origin, { method: `POST`, body: e }).arrayBuffer()
          ).byteLength;
    ...
    return async (e) => {
      ...
      let T = an([l, u && u.toAbortSignal()], d),
        E = null,
        ne =
          T &&
          T.unsubscribe &&
        ...
        re;
      try {
        if (w && typeof t == `string` && t.startsWith(`data:`) && un(t) > S)
          throw new M(
  ...
  _n = (e) => {
    ...
    for (; o--; )
      ((s = a[o]),
        (c = l.get(s)),
        c === void 0 && l.set(s, (c = o ? new Map() : hn(t))),
        (l = c));
    return c;
  };
_n();
var vn = { http: null, xhr: rn, fetch: { get: _n } };
j.forEach(vn, (e, t) => {
  if (e) {
    try {
...
var yn = (e) => `- ${e}`,
  bn = (e) => j.isFunction(e) || e === null || e === !1;
function xn(e, t) {
  e = j.isArray(e) ? e : [e];
  let { length: n } = e,
    r,
  ...
  for (let o = 0; o < n; o++) {
    ...
    if (
      ((i = r),
      !bn(r) && ((i = vn[(n = String(r)).toLowerCase()]), i === void 0))
    )
...
var Sn = { getAdapter: xn, adapters: vn };
function Cn(e) {
  if (
  ...
  return (
    ...
    Sn.getAdapter(
      ...
      function (t) {
        ...
        return ((t.headers = ot.from(t.headers)), t);
      },
      function (t) {
        if (!Lt(t) && (Cn(e), t && t.response)) {
          e.response = t.response;
          try {
            t.response.data = It.call(e, e.transformResponse, t.response);
          } finally {
            delete e.response;
          }
          t.response.headers = ot.from(t.response.headers);
        }
...
var On = { assertOptions: Dn, validators: Tn },
  kn = On.validators,
  An = class {
    constructor(e) {
      ((this.defaults = e || {}),
        (this.interceptors = { request: new bt(), response: new bt() }));
    }
    async request(e, t) {
      try {
      ...
      (n !== void 0 &&
        On.assertOptions(
          n,
          {
            ...
            legacyInterceptorReqResOrdering: kn.transitional(kn.boolean),
          },
          !1,
        ),
        r != null &&
...
(j.forEach([`delete`, `get`, `head`, `options`], function (e) {
  ...
  j.forEach([`post`, `put`, `patch`, `query`], function (e) {
    ...
    ((An.prototype[e] = t()),
      e !== `query` && (An.prototype[e + `Form`] = t(!0)));
  }));
var jn = class e {
  constructor(e) {
...
function Fn(e) {
  let t = new An(e),
    n = p(An.prototype.request, t);
  return (
    j.extend(n, An.prototype, t, { allOwnKeys: !0 }),
...
((F.Axios = An),
  ...
  (F.mergeConfig = Qt),
  (F.AxiosHeaders = ot),
  (F.formToJSON = (e) => Mt(j.isHTMLForm(e) ? new FormData(e) : e)),
  (F.getAdapter = Sn.getAdapter),
  (F.HttpStatusCode = Pn),
  (F.default = F));
var In = t((e) => {
    var t = Symbol.for(`react.transitional.element`),
...
function Rn() {
  ...
  function r(e) {
    e.preventDefault();
    let { title: t, discription: r } = e.target.elements;
    (console.log(t.value, r.value),
      F.post(`http://localhost:3000/api/notes`, {
        title: t.value,
        discription: r.value,
      })
        .then((e) => {
          (console.log(`Data submitted sucessfully`), n());
        })
        .catch((e) => {
          console.log(`Failed`);
        }));
  ...
  function i(e) {
    (console.log(e),
      F.delete(`http://localhost:3000/api/notes/${e}`).then((e) => {
      ...
      children: [
        (0, Ln.jsxs)(`form`, {
          ...
          children: [
            ...
            (0, Ln.jsx)(`button`, { children: `Create note` }),
          ],
        }),
        (0, Ln.jsx)(`div`, {
          className: `notes`,
          children: e.map((e, t) =>
            (0, Ln.jsxs)(
              `div`,
              {
                className: `note`,
                children: [
                  (0, Ln.jsx)(`h1`, { children: e.title }),
                  (0, Ln.jsx)(`p`, { children: e.description }),
                  (0, Ln.jsx)(`button`, {
                    onClick: () => i(e._id),
                    children: `Delete`,
                  }),
...
(0, f.createRoot)(document.getElementById(`root`)).render(
  (0, Ln.jsx)(d.StrictMode, { children: (0, Ln.jsx)(Rn, {}) }),
);
